...
\centering \textbf{Prof. Guide Name} & & \centering \textbf{Prof. HOD Name} \\
\centering Project Guide & & \centering Head of Department
\end{tabular}

\vspace{2.5cm}
\textbf{Dr. Principal Name} \\
...
\begin{longtable}{|p{0.8cm}|p{2.5cm}|p{3cm}|p{3.5cm}|p{3.5cm}|p{1.2cm}|}
\hline
